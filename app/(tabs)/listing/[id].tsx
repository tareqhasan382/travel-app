  ...
  return (
    <ScrollView style={tw`bg-white`}>
      ...
      <View style={tw`relative`}>
        <Image source={{ uri: item.image }} style={tw`h-80 w-full`} />

        <Pressable
          onPress={() => router.back()}
          style={tw`absolute top-12 left-4 bg-white p-2 rounded-full`}
        >
      ...
      <View style={tw`p-6`}>
        ...
        <Text style={tw`text-gray-500 mt-1`}>{item.location}</Text>
        ...
        <View style={tw`flex-row justify-between items-center mt-6`}>
          ...
          <Pressable style={tw`bg-blue-600 px-6 py-3 rounded-xl`}>
